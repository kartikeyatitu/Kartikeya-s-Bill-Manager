  ...
  let template = (
    <div className="add-biller">
        ...
        <div className="pos-r">
            ...
            <label className="biller-label" htmlFor="add-biller-name"> Your Expense </label>
        </div>
        ...
        </div>
        {
            formError && <div className="error-msg">
                Please Enter Valid Values category or amount cannot be left empty. Please enter numeric values only for amounts.
            </div>
        }
    </div>
